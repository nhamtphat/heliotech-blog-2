...
import githubActionUnittest from './1.png'
...
export const meta = {
    ...
    description:
        'Cách đơn giản để setup Github Action tự động làm các công việc  chạy unit test, kiểm tra code style hay thậm chí deploy sản phẩm tự động khi bạn push code lên Github.',
}
...
<Image src={githubActionUnittest} alt="" />

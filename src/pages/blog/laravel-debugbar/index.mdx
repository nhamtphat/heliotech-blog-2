...
import laravelDebugbar from './laravel-debugbar.png'
...
export const meta = {
    ...
    description:
        'Laravel Debugbar là một package mình dùng trong hầu hết các dự án, nó giúp mình debug và theo dõi các query của ứng dụng trong mỗi request',
}

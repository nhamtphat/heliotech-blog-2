...
export const meta = {
    ...
    description:
        'Laravel cung cấp cho bạn một tính năng Soft deletes rất hữu ích, tuy nhiên nó lại đi kèm với nhiều thử thách, một trong số đó là xoá các quan hệ con.',
}

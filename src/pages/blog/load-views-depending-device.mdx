...
export const meta = {
    ...
    description:
        'Nếu bạn có hai giao diện riêng dành cho điện thoại và máy tính, bạn có thể đặt tên file giống nhau và tách ra hai thư mục riêng, việc này sẽ giúp bạn xác định thư mục nào sẽ được load',
}

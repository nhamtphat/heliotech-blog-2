...
export const meta = {
    ...
    description:
        'Gitlab Runner là một phần mềm chạy trên máy tính cho phép Gitlab sử dụng máy tính như một runner để chạy các cấu hình CI/CD, việc này giúp bạn tối ưu chi phí khi sử dụng hết free quota hàng tháng của Gitlab',
}

...
export const meta = {
    ...
    description:
        'Symfony và Laravel đều là framework mã nguồn mở được viết dựa trên ngôn ngữ PHP, liệu rằng Symfony có những điểm mạnh và điểm yếu như thế nào so với Laravel?',
}

...
export const meta = {
    ...
    description:
        'Hướng dẫn tạo và cấu hình cơ sở dữ liệu MySQL với ứng dụng Laravel. Và một mẹo nhỏ để kiểm tra kết nối đã thành công hay chưa mà không làm ảnh hưởng đến CSDL',
}
